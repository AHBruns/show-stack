                        ...
                        <div className="max-w-screen-xl px-4 mx-auto mt-10 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                            <div className="sm:text-center lg:text-left">
                                ...
                                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                                    ...
                                    Gone are the days of maintaining different
                                    queues on all your favorite streaming
                                    platforms. WatchThis is your single source
                                    of truth for all your favorite series &
                                    movies.
                                </p>
